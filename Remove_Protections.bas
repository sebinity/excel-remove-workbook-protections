Attribute VB_Name = "Remove_Protections"
Option Explicit
...
Sub RemoveProtection()
    ...
    Name sourceFilePath & tempFileName & ".zip" As sourceFilePath & sourceFileName & "_unprotected_" & Format(Now, "yyyymmdd") & "." & sourceFileType
